    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">
        ...
        <span class="d-none d-lg-block">
          <img class="img-fluid img-profile rounded-circle mx-auto mb-2" src="<?= base_url()?>assets/profil/img/profile.jpg" alt="">
        </span>
      </a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ">
          ...
          <li class="nav-item">
           ...
           <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="">Forum Alumni</a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="">Jadwal Reuni</a>
          </li>
           <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="<?=base_url()?>profile/edit/<?=$nisn?>">Edit Pofil</a>
          </li>
          <li class="nav-item">
