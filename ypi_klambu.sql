...
--
-- Host: localhost
-- Generation Time: Feb 20, 2019 at 09:40 AM
...
INSERT INTO `admin` (`id`, `nama`, `username`, `password`, `no_hp`, `level`) VALUES
(8, 'Suluh Arwani', 'suluh', '$2a$08$K748FHBGphP0i3IqK08pNunAvsnKOP81iwaZISe.r9tYqF4edopJq', '089685032675', 1);
...
CREATE TABLE `alumni` (
  ...
  `status_kuliah` int(11) DEFAULT NULL,
  `status_kerja` int(11) DEFAULT NULL,
  `status_belum_kerja` int(11) DEFAULT NULL,
  `tempat_lahir` varchar(255) NOT NULL,
  `foto` varchar(255) DEFAULT 'logo_def.png',
...
INSERT INTO `alumni` (`id`, `nama`, `nisn`, `jenis_kelamin`, `password`, `email`, `no_hp`, `pekerjaan`, `alamat`, `angkatan`, `keahlian`, `nama_belakang`, `status_kuliah`, `status_kerja`, `status_belum_kerja`, `tempat_lahir`, `foto`, `tanggal_lahir`, `status`) VALUES
(1, 'nama1', '12345', '1', '$2a$08$UpiY09413sPxKkXy77iXhOgnRTQH6RNSjZvR64lLY50B.MMKIQw4a', 'mail1', '898989898', NULL, 'klambu', 1999, NULL, 'nama belakang 1', NULL, NULL, NULL, '', 'logo_def.png', '0000-00-00', 1),
(2, 'nama2', '12346', '2', '$2a$08$aT/9wR15yaOBk38QdlIeaO77sf2o7wRmOSbiVgqyjVIEpDWyo9KbS', 'mail2', '898989899', NULL, 'klambu', 1999, NULL, 'nama belakang 2', NULL, NULL, NULL, '', 'logo_def.png', '0000-00-00', 1),
(3, 'nama3', '12347', '1', '$2a$08$v3Tyz/mboP0Yfh5T.sgwm.EqbS5EB66NI/TsaONy2MgXgS4U34MXu', 'mail3', '898989900', NULL, 'klambu', 2000, NULL, 'nama belakang 3', NULL, NULL, NULL, '', 'logo_def.png', '0000-00-00', 1),
(4, 'nama4', '12348', '2', '$2a$08$06H68ckyFyiKBChsXDD/fuodlMrv32AEI0zWvZxWBw9ELRU6vv7sS', 'mail4', '898989901', NULL, 'klambu', 2001, NULL, 'nama belakang 4', NULL, NULL, NULL, '', 'logo_def.png', '0000-00-00', 1),
(5, 'nama5', '12349', '1', '$2a$08$wBKSRAivYnYWW0MpF1wRueiNf5b5ZTORNcqCVA5O7kwGfj.aBZvjW', 'mail5', '898989902', NULL, 'klambu', 2002, NULL, 'nama belakang 5', NULL, NULL, NULL, '', 'logo_def.png', '0000-00-00', 1),
(6, 'nama6', '12350', '2', '$2a$08$Usl9vr15W3TjeZ9D2zdVvuYr4HiITcrWOdUrdxl6Ps/WtBdtNTg8e', 'mail6', '898989903', NULL, 'klambu', 2003, NULL, 'nama belakang 6', NULL, NULL, NULL, '', 'logo_def.png', '0000-00-00', 1),
(7, 'nama7', '12351', '1', '$2a$08$PVIeDuN9d5gdYVZVRTLHVeQRVbw3gjSVv3TsTneMRbrHVgAbGB.OC', 'mail7', '898989904', NULL, 'klambu', 2004, NULL, 'nama belakang 7', NULL, NULL, NULL, '', 'logo_def.png', '0000-00-00', 1),
(8, 'nama8', '12352', '1', '$2a$08$tCT9H4XKeW4IHSEKmt5FjejZiqhPfMOC.L9Sl4g9KXTLNUETiXGLC', 'mail8', '898989905', NULL, 'klambu', 2005, NULL, 'nama belakang 8', NULL, NULL, NULL, '', 'logo_def.png', '0000-00-00', 1),
(9, 'nama9', '12353', '1', '$2a$08$oD45da8hdpKt5oU7lhOTluRBSHU8hI7SsnWJKEv2hifn7eSYHhlmq', 'mail9', '898989906', NULL, 'klambu', 2006, NULL, 'nama belakang 9', NULL, NULL, NULL, '', 'logo_def.png', '0000-00-00', 1),
(10, 'nama10', '12354', '1', '$2a$08$NdLWvDInfqMcG/jKNi3U8uR.LC2HWKbDEu2/Yy6xW7ugMNEG7o2xq', 'mail10', '898989907', NULL, 'klambu', 2007, NULL, 'nama belakang 10', NULL, NULL, NULL, '', 'logo_def.png', '0000-00-00', 1),
(18, 'nama1', '12345', '1', '$2a$08$LrurokkGFuVgReHvxOf/W.dRWU4LB6cR.h5LkduQgEV4FDS.KInGe', 'mail1', '898989898', NULL, 'klambu', 1999, NULL, 'nama belakang 1', NULL, NULL, NULL, '', 'logo_def.png', '0000-00-00', 1),
(19, 'nama2', '12346', '2', '$2a$08$0DAm.QnGAG0tXishL4nOkO3VEqAgZ1iMQFFJbVYzE1b8F1rNOlb8u', 'mail2', '898989899', NULL, 'klambu', 1999, NULL, 'nama belakang 2', NULL, NULL, NULL, '', 'logo_def.png', '0000-00-00', 1),
(20, 'nama3', '12347', '1', '$2a$08$wRgcc.ce6lYcFByKPcUTz.1CwgzIHpL3Al03UhROCHQbBlWOD5x/m', 'mail3', '898989900', NULL, 'klambu', 2000, NULL, 'nama belakang 3', NULL, NULL, NULL, '', 'logo_def.png', '0000-00-00', 1),
(21, 'nama4', '12348', '2', '$2a$08$X0q8cPvAzXd.GRkYtcaMJe6Ql/0LvUDxFAk8TrB68HtnSDY/vAfdC', 'mail4', '898989901', NULL, 'klambu', 2001, NULL, 'nama belakang 4', NULL, NULL, NULL, '', 'logo_def.png', '0000-00-00', 1),
(22, 'nama5', '12349', '1', '$2a$08$vnZ1K.BJvHUDhGZColtT/ezWFxObGycVBerhtPCjBodK2E/kADmKO', 'mail5', '898989902', NULL, 'klambu', 2002, NULL, 'nama belakang 5', NULL, NULL, NULL, '', 'logo_def.png', '0000-00-00', 1),
(23, 'nama6', '12350', '2', '$2a$08$DzaQHpmyYGiGO2Fvv/ESCe3X6ar0yzr05x1oqwpIwCd9rZeKLyp7W', 'mail6', '898989903', NULL, 'klambu', 2003, NULL, 'nama belakang 6', NULL, NULL, NULL, '', 'logo_def.png', '0000-00-00', 1),
(24, 'nama7', '12351', '1', '$2a$08$8XZzYpUTKSR6lqfBXDbtOONmqH1A.xnna1kouSObXgoxFSxh585Ee', 'mail7', '898989904', NULL, 'klambu', 2004, NULL, 'nama belakang 7', NULL, NULL, NULL, '', 'logo_def.png', '0000-00-00', 1),
(25, 'nama8', '12352', '1', '$2a$08$v54.qTdWWkqV7GTyA3XAbeTKk2A7dvEw820150l4hcquxiI6PEwiO', 'mail8', '898989905', NULL, 'klambu', 2005, NULL, 'nama belakang 8', NULL, NULL, NULL, '', 'logo_def.png', '0000-00-00', 1),
(26, 'nama9', '12353', '1', '$2a$08$LvjxoKkxyzYMlQnvLwPfKeO6EzYAflY8ROfdHl2NUnbfKiWSZEfu6', 'mail9', '898989906', NULL, 'klambu', 2006, NULL, 'nama belakang 9', NULL, NULL, NULL, '', 'logo_def.png', '0000-00-00', 1),
(27, 'nama10', '12354', '1', '$2a$08$qfg/jplVYHt/QFhZYXsJRebOm954bhpS4Mhsv5cQKxFnGrMkDd5om', 'mail10', '898989907', NULL, 'klambu', 2007, NULL, 'nama belakang 10', NULL, NULL, NULL, '', 'logo_def.png', '0000-00-00', 1),
(28, 'nama11', '12355', '1', '$2a$08$vo8uUp8kl77MYqs7c9JZ1O0JxjX6ajgSUxW4ew4ZTq8YHtyo.z6cu', 'mail11', '898989908', NULL, 'klambu', 2008, NULL, 'nama belakang 11', NULL, NULL, NULL, '', 'logo_def.png', '0000-00-00', 1),
(29, 'nama12', '12356', '1', '$2a$08$CD8C9dvm0qfP7libYQsnheKSZjRxfHKaauidfFwmpwTRt40LsuGGW', 'mail12', '898989909', NULL, 'klambu', 2009, NULL, 'nama belakang 12', NULL, NULL, NULL, '', 'logo_def.png', '0000-00-00', 1),
(31, 'nama14', '12358', '1', '$2a$08$gbpb7I/StVmtLdCXfNeZZ.srQS5bF9FjtOJr.xTeMOlu4zYDYnqBq', 'mail14', '898989911', NULL, 'klambu', 2011, NULL, 'nama belakang 14', NULL, NULL, NULL, '', 'logo_def.png', '0000-00-00', 1);

-- --------------------------------------------------------

--
-- Table structure for table `alumni_tentang`
--

CREATE TABLE `alumni_tentang` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `alumni_tentang`
--

INSERT INTO `alumni_tentang` (`id`, `id_alumni`, `tentang`, `link_fb`, `link_tw`, `link_in`, `link_ig`, `link_wa`, `link_git`) VALUES
(1, 16, '<!DOCTYPE html>\r\n<html>\r\n<head>\r\n</head>\r\n<body>\r\n<ol>\r\n<li>Pelanggan mengalami kendala dengan ac nya</li>\r\n<li>2. Menghubungi call center rejeki utama umtuk mendapatkan solusi terbaik</li>\r\n<li>Pihak costumer service kami akan membuatkan jadwal pengecekan ke lokasi anda 4. Teknisi kami tiba di lokasi anda max 1x24 jam untuk melanjutkan pengecekan dan perbaikan ac anda 5. AC anda sehat kembali Dapatkan garansi perbaikan selama 60 hari. Work free.</li>\r\n<li>&nbsp;</li>\r\n<li>&nbsp;</li>\r\n<li><img src=\"http://localhost/mayang/assets/gambar/berita/post-image-1541448010654.jpg\" alt=\"\" width=\"418\" height=\"314\" /></li>\r\n</ol>\r\n</body>\r\n</html>', 'https://www.facebook.com/suluh.k.kegelapan', 'https://twitter.com/suluharwani', 'https://www.linkedin.com/in/suluh-arwani-263526103/', 'mayangarta', '089685032675', 'https://github.com/suluharwani');
...
INSERT INTO `data_berita` (`id_berita`, `id_pengguna`, `tanggal_berita`, `judul`, `isi`, `status`, `gambar`, `penulis`, `url`) VALUES
(9, 8, '2018-11-18', 'nh', '<!DOCTYPE html>\r\n<html>\r\n<head>\r\n</head>\r\n<body>\r\n<p>tunbfrtybfggf</p>\r\n</body>\r\n</html>', 1, '56.png', 'Suluh Arwani', 'nh'),
(10, 8, '2019-02-15', 'Informasi NISN', '<!DOCTYPE html>\r\n<html>\r\n<head>\r\n</head>\r\n<body>\r\n<p><span style=\"color: #2a2a2a; font-family: Roboto, sans-serif;\">KOMPAS.com -&nbsp;Nomor Induk Siswa Nasional (NISN) adalah kode pengenal identitas siswa yang bersifat unik, standar dan berlaku sepanjang masa yang dapat membedakan satu siswa dengan siswa lainnya di seluruh sekolah Indonesia dan Sekolah Indonesia di Luar Negeri. NISN diberikan kepada setiap siswa yang bersekolah di satuan pendidikan yang terdaftar di Referensi Kemendikbud.&nbsp; Selain untuk mengidentifikasi setiap individu siswa di seluruh sekolah se-Indonesia secara standar, konsisten dan berkesinambungan, NISN sangat penting dimiliki oleh siswa untuk menunjang kegiatan administrasi terkait pembelajaran di antaranya: Bantuan Operasional Sekolah (BOS), Ujian Nasional (UN), hingga Seleksi Nasional Masuk Perguruan Tinggi Negeri ( SNMPTN). Berdasarkan data dari laman resmi Dapodik (Data Pokok Pendidikan Nasional) Kemendikbud, berikut beberapa solusi bila terjadi masalah NISN siswa: 1. Apakah sudah terdaftar NISN, berapa nomor induk siswa nasional saya? Untuk mengetahui NISN, silakan cek di menu DATA SISWA atau klik pada link ini pada situs NISN, melalui tautan:&nbsp;http://nisn.data.kemdikbud.go.id/page/data Pengecekan dapat dilakukan dengan 2 metode: Baca juga: Mengintip Kisi-Kisi Resmi UN dan USBN 2019, Unduh Di Sini&nbsp; Memasukan nomor NISN bila sudah memiliki atau Memasukan nama lengkap (sesuai akta lahir), tempat lahir dan tanggal lahir bila belum mengetahui NISN. 2. Belum memiliki NISN, bagaimana mengurusnya? Dianjurkan melakukan pengecekan lebih dahulu seperti langkah di atas. Jika siswa tidak ditemukan, silakan download (unduh) Formulir Peserta Didik (F-PD) dan formulir A.1 pengajuan Nomor Induk Siswa Nasional (NISN) baru pada situs NISN http://nisn.data.kemdiknas.go.id&nbsp;melalui menu FORMULIR PENGAJUAN Mencetak formulir-formulir tersebut Mengisi formulir-formulir tersebut secara manual Menyerahkan kepada operator NISN/NPSN atau sekolah dimana siswa berasal Bagi pihak sekolah dapat mengirim formulir A.1. tersebut ke PDSP melalui email : pdsp@kemdiknas.go.id untuk diberikan NISN. 3. Bagaimana cara memperbaiki biodata NISN bila data tertera tidak sesuai dengan akta kelahiran? Silakan download (unduh) formulir A.3. Pengajuan Perbaikan Biodata Siswa di situs NISN http://nisn.data.kemdiknas.go.id&nbsp;pada menu FORMULIR PENGAJUAN Mencetak formulir tersebut Mengisi formulir tersebut secara manual Menyerahkan kepada operator tingkat sekolah dimana NISN tersebut diterbitkan Bagi sekolah, dapat mengirimkan formulir yang sudah diperbaiki tersebut ke&nbsp; PDSP melalui email : pdsp@kemdiknas.go.id. 4. Di sekolah saya yang sekarang ditanyakan NISN, padahal pada saat lulus dari sekolah sebelumnya tidak dibekali NISN? Dianjurkan terlebih dahulu untuk melaksanakan solusi seperti pada permasalahan No.1 diatas. Jika tidak ditemukan, silakan download (unduh) formulir peserta didik (F-PD) dan formulir A.1. pengajuan Nomor Induk Siswa Nasional (NISN) baru pada situs NISN http://nisn.data.kemdiknas.go.id&nbsp; melalui menu FORMULIR PENGAJUAN. Mencetak formulir-formulir tersebut Mengisi formulir-formulir tersebut secara manual Menyerahkan kepada operator NISN/NPSN sekolah asal Bagi pihak sekolah dapat mengirim formulir A.1. tersebut ke PDSP melalui email : pdsp@kemdiknas.go.id untuk diberikan NISN.&nbsp; 5. Kartu NISN saya hilang, datanya juga ada yang keliru, bagaimana ini? Jika terjadi kesalahan, kerusakan atau kehilangan kartu NISN, silakan dilaporkan ke operator NISN/NPSN sekolah dimana NISN tersebut diterbitkan. 6. Bagaimana jika ada 1 orang siswa memiliki 2 (dua) NISN? NISN yang mana yang di digunakan? NISN yang digunakan adalah NISN yang sudah digunakan sebagai alat administrasi dan validasi oleh siswa di sekolahnya. Jika tidak, NISN yang digunakan adalah NISN yang paling kecil kodenya. Untuk NISN yang tidak digunakan mohon segera melapor ke operator NISN/NPSN sekolah asal untuk segera dihapus.</span><br style=\"box-sizing: border-box; color: #2a2a2a; font-family: Roboto, sans-serif;\" /><br style=\"box-sizing: border-box; color: #2a2a2a; font-family: Roboto, sans-serif;\" /><span style=\"color: #2a2a2a; font-family: Roboto, sans-serif;\">Artikel ini telah tayang di&nbsp;</span><a style=\"box-sizing: border-box; vertical-align: top; outline: 0px; transition: all 0.2s ease 0s; text-decoration-line: none; font-family: Roboto, sans-serif;\" href=\"http://kompas.com/\">Kompas.com</a><span style=\"color: #2a2a2a; font-family: Roboto, sans-serif;\">&nbsp;dengan judul \"Cara Mengetahui Nomor Induk Siswa Nasional dan 6 Solusi Masalahnya\",&nbsp;</span><a style=\"box-sizing: border-box; vertical-align: top; outline: 0px; transition: all 0.2s ease 0s; text-decoration-line: none; font-family: Roboto, sans-serif;\" href=\"https://edukasi.kompas.com/read/2018/12/20/14070141/cara-mengetahui-nomor-induk-siswa-nasional-dan-6-solusi-masalahnya\">https://edukasi.kompas.com/read/2018/12/20/14070141/cara-mengetahui-nomor-induk-siswa-nasional-dan-6-solusi-masalahnya</a><span style=\"color: #2a2a2a; font-family: Roboto, sans-serif;\">.&nbsp;</span><br style=\"box-sizing: border-box; color: #2a2a2a; font-family: Roboto, sans-serif;\" /><span style=\"color: #2a2a2a; font-family: Roboto, sans-serif;\">Penulis : Yohanes Enggar Harususilo</span><br style=\"box-sizing: border-box; color: #2a2a2a; font-family: Roboto, sans-serif;\" /><span style=\"color: #2a2a2a; font-family: Roboto, sans-serif;\">Editor : Yohanes Enggar Harususilo</span></p>\r\n</body>\r\n</html>', 1, '44359375_329572274260794_5080260890222133248_n.jpg', 'Suluh Arwani', 'informasi_nisn');

-- --------------------------------------------------------

--
-- Table structure for table `data_login_guru`
--

CREATE TABLE `data_login_guru` (
  `id` int(11) NOT NULL,
...
(1, 'Suluh Arwani', '12345', '$2a$08$K748FHBGphP0i3IqK08pNunAvsnKOP81iwaZISe.r9tYqF4edopJq');

-- --------------------------------------------------------

--
-- Table structure for table `informasi_pengajaran`
--

CREATE TABLE `informasi_pengajaran` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `interest_alumni`
--

CREATE TABLE `interest_alumni` (
  `id` int(11) NOT NULL,
  `id_alumni` int(11) NOT NULL,
  `interest` text
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Dumping data for table `interest_alumni`
--

INSERT INTO `interest_alumni` (`id`, `id_alumni`, `interest`) VALUES
(1, 16, '<!DOCTYPE html>\r\n<html>\r\n<head>\r\n</head>\r\n<body>\r\n<p>coba interest coba ya</p>\r\n<p>&nbsp;</p>\r\n<p>&nbsp;</p>\r\n</body>\r\n</html>');
...
INSERT INTO `mata_pelajaran` (`id`, `nama_mata_pelajaran`, `id_jurusan`, `tingkat`) VALUES
(1, 'Biologi', 1, 'Kelas X'),
(2, 'Ekonomi', 2, 'kelas XI'),
(3, 'Fisika', 1, 'kelas xii');
...
INSERT INTO `materi_guru` (`id`, `nama_materi`, `file`, `keterangan`, `id_guru`, `id_mata_pelajaran`, `id_jurusan`, `tanggal_buat`) VALUES
(1, 'Coba Materi', 'materi_ipa_1.zip', 'materi_ipa_1.zip', 1, 1, 1, '2019-02-17'),
(2, 'coba materi', 'JADWAL_ADZAN5.xlsx', '                              ', 1, 0, 0, '0000-00-00'),
(3, 'coba materi', 'cover_ABSENSI.docx', '                              ', 0, 0, 0, '0000-00-00'),
(4, 'coba materi cak', 'WinDjView-2.1-Setup.exe', '                          ', 1, 1, 1, '0000-00-00'),
(5, 'coba materi lagi lah', 'inggris_semester_genap_2019_middle.docx', '                          ', 1, 1, 1, '2019-02-20'),
(6, 'coba materi lagi lah', 'inggris_semester_genap_2019_middle1.docx', '<p>ini coba-coba</p>\r\n', 1, 1, 1, '2019-02-20'),
(7, 'coba materi', '44455204_329970234220998_6756867082920394752_n.jpg', '                          ', 1, 1, 1, '2019-02-20'),
(8, 'coba materi', '8jtu2cb1yo.jpg', '                          ', 1, 1, 1, '2019-02-20'),
(9, 'coba materi cak', 'inggris_semester_genap_2019_middle2.docx', '                          ', 1, 1, 1, '2019-02-20'),
(10, 'coba materi cak', 'inggris_semester_genap_2019_middle3.docx', '<p>feqw</p>\r\n', 1, 1, 1, '2019-02-20'),
(11, 'fwfwfwfw', 'Pengertian_Menurut_bahasa.docx', '                              ', 1, 1, 1, '2019-02-20'),
(12, 'fwfwfwfw', 'Pengertian_Menurut_bahasa1.docx', '<p>vwe</p>\r\n', 1, 1, 1, '2019-02-20'),
(13, 'fwfwfwfw', 'Pengertian_Menurut_bahasa2.docx', '<p>vwe</p>\r\n', 1, 1, 1, '2019-02-20'),
(14, 'coba materi upload', 'inggris_semester_genap_2019_middle4.docx', '                              ', 1, 1, 1, '2019-02-20'),
(15, 'coba materi', 'Surat_tugas_Pak_Muklas.docx', '                              ', 1, 3, 1, '2019-02-20'),
(16, 'fwfwfwfw', 'Surat_tugas_Pak_Muklas1.docx', '<p>s</p>\r\n', 1, 3, 1, '2019-02-20'),
(17, 'coba materi', 'GNOTA_MTS.xlsx', '                              ', 1, 1, 1, '2019-02-20'),
(18, 'coba materi', 'Surat_tugas_Pak_Muklas2.docx', '                              ', 1, 3, 1, '2019-02-20'),
(19, 'coba materi', 'Surat_tugas_Pak_Muklas3.docx', '<p>d</p>\r\n', 1, 3, 1, '2019-02-20'),
(20, 'f', 'PMR.xlsx', '                              ', 1, 3, 1, '2019-02-20'),
(21, 'fwfwfwfw', 'GNOTA_MTS1.xlsx', '                              ', 1, 1, 1, '2019-02-20'),
(22, 'coba materi', 'Surat_tugas_Pak_Muklas4.docx', '                              ', 1, 2, 2, '2019-02-20'),
(23, 'coba materi', 'GNOTA_MTS2.xlsx', '                              ', 1, 3, 1, '2019-02-20'),
(24, '123', 'GNOTA_MTS3.xlsx', '<p>d</p>\r\n', 1, 3, 1, '2019-02-20'),
(25, 'coba materisswsws', 'Surat_tugas_Pak_Muklas5.docx', '                              ', 1, 3, 1, '2019-02-20'),
(26, '12224545', 'Surat_tugas_Pak_Muklas6.docx', '<p>sw</p>\r\n', 1, 3, 1, '2019-02-20');
...
INSERT INTO `pendidikan_alumni` (`id`, `id_alumni`, `sekolah`, `jurusan`, `lulus`) VALUES
(1, 38, 'MA', 'IPS', '');
...
--
-- Table structure for table `pengalaman_alumni`
--

CREATE TABLE `pengalaman_alumni` (
  `id` int(11) NOT NULL,
  `id_alumni` int(11) NOT NULL,
  `pengalaman` varchar(255) NOT NULL,
  `instansi` varchar(255) NOT NULL,
  `keterangan` text NOT NULL,
  `mulai_masuk` varchar(255) NOT NULL,
...
--
-- Table structure for table `penghargaan_alumni`
--

CREATE TABLE `penghargaan_alumni` (
  `id` int(11) NOT NULL,
  `id_alumni` int(11) NOT NULL,
...
--
-- Dumping data for table `penghargaan_alumni`
--

INSERT INTO `penghargaan_alumni` (`id`, `id_alumni`, `penghargaan`, `juara`) VALUES
(1, 16, 'makan banyak', 1),
(2, 16, 'makan banyak sekali', 3),
(3, 16, 'makan banyak kok', 0),
(4, 16, 'makan banyak', 1),
(5, 38, 'LOMBA BURUNG', 1),
(6, 38, 'MAKAN KERUPUK', 2),
(7, 38, 'LOMBA BURUNG 1', 11);
...
CREATE TABLE `riwayat_mengajar_guru` (
  `id` int(11) NOT NULL,
  `id_guru` int(11) NOT NULL,
  `tahun_akademik_awal` int(11) NOT NULL,
  `tahun_akademik_akhir` int(11) NOT NULL,
...
INSERT INTO `skill` (`id`, `id_alumni`, `keahlian`) VALUES
(1, 38, 'TUKANG KETIK');
...
--
-- Indexes for table `alumni_tentang`
--
ALTER TABLE `alumni_tentang`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `data_login_guru`
--
ALTER TABLE `data_login_guru`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `informasi_pengajaran`
--
ALTER TABLE `informasi_pengajaran`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `interest_alumni`
--
ALTER TABLE `interest_alumni`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `pengalaman_alumni`
--
ALTER TABLE `pengalaman_alumni`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `penghargaan_alumni`
--
ALTER TABLE `penghargaan_alumni`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `alumni_tentang`
--
ALTER TABLE `alumni_tentang`
...
--
ALTER TABLE `data_berita`
  MODIFY `id_berita` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT for table `data_login_guru`
--
ALTER TABLE `data_login_guru`
...
ALTER TABLE `guru`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `informasi_pengajaran`
--
ALTER TABLE `informasi_pengajaran`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
ALTER TABLE `info_siswa`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `interest_alumni`
--
ALTER TABLE `interest_alumni`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
-- AUTO_INCREMENT for table `pendidikan_alumni`
--
ALTER TABLE `pendidikan_alumni`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
ALTER TABLE `pendidikan_guru`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `pengalaman_alumni`
--
ALTER TABLE `pengalaman_alumni`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `penghargaan_alumni`
--
ALTER TABLE `penghargaan_alumni`
