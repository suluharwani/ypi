<?php
$base_url_id = $this->config->item('base_url_id');
...
$harga_unik = "Rp " . number_format(($harga+$kode_unik),2,',','.');
        ...
        <div class="col-lg-4" style="font-size: 17px; margin-bottom: 20px;">
          <p>
            ...
            <?php 
              if ($status==1) {?>
                <label>Status:</label>
                <img src="<?php echo base_url()?>assets/template_web/images/lunas.png" class="img-responsive" alt="Responsive image">
                <span class="label label-warning"><b>Silahkan cetak invoice ini sebagai bukti pembayaran.</b></span>
              <?php }else{?>
                <label>Status:</label>
                <span class="label label-warning"><b>Batas Bayar:</b> <?=$tgl_akhir?> (Satu hari)</span><br>
                <h3><b>Biaya Pendaftaran:</b> <?=$harga_rupiah ?></h3>
               <?php if ($tipe_bayar==1) {?>
                 <div>
                  <i style="color: red; font-size: 14px;">Silahkan melakukan <strong>konfirmasi pembayaran</strong> terlebih dahulu, kemudian <strong>mengupload bukti pembayaran</strong>:</i>
                  <button type="button" class="btn btn-sm btn-success" data-toggle="modal" data-target="#konfirmasi">Konfirmasi Pembayaran</button>
                  <?php $update_id = $this->uri->segment(3);?>
                  <a href="<?php echo base_url()?>home/upload_gambar/<?= $update_id?>"><button type="button" class="btn btn-sm btn-info">Upload Gambar Bukti Transfer</button></a>
                </div>
               <?php } ?>
                
          </p>
        </div>
        <div align="right" class="col-lg-12"><i style="color: red; font-size: 12px;">*) Proses konfirmasi pembayaran memakan waktu kurang lebih <strong>1 x 24 jam</strong>.</i></div><?php } ?>
      </div>
      <div class="col-lg-12" style="color: #455A64; margin-top: 20px; margin-bottom: 20px;">
        <div class="table-responsive">
          <table class="table table-striped">
            ...
            <tbody>
              ...
              <tr>
                <td>5</td>
                <td>Masukan jumlah transfer sebesar <?=$harga_unik ?> (tanpa dua angka nol dibelakang koma).</td>
              </tr>
              <tr>
                <td>6</td>
              ...
              <tr>
                <td>8</td>
                <td>Pembayaran telah sukses. Tunggu hingga pembayaran anda dikonfirmasi. Proses konfirmasi memakan waktu kurang lebih <strong>1 x 24 jam</strong>.</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="POST">
            ...
            <br>
            <label>Asal Bank Pengirim:</label>
            <div class="input-group">
              <span class="input-group-addon" id="sizing-addon2"><span class="glyphicon glyphicon-home" aria-hidden="true"></span></span>
              <input type="text" id="message" class="form-control" name="bank_asal" placeholder="Contoh: Bank Mandiri" aria-describedby="sizing-addon2" value="<?=$bank_asal?>" required="">
            </div>
             <div class="input-group">
              
              <input type="hidden" class="form-control" name="ada_bukti" aria-describedby="sizing-addon2" value="1" >
            </div>
            <br>
        ...
        <div class="modal-footer">
          <?php 
              if (!isset($namarek)) {
            ?>
              <button type="submit" name="submit" value="submit" class="btn btn-success">Konfirmasi</button>
            <?php }else{?>
