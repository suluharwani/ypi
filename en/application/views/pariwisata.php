...
<html lang="en">
  <head>
    ...
    <title>Central Celebes Marathon: Tourism </title>
  ...
  <body>
          ...
          <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="<?=base_url()?>home/pariwisata">TOURISM</a></li>
      ...
      <section class="parallax-header">
        <div class="container">
          <div class="col-lg-12">
            <h2 class="judulheader" align="center">TOURISM</h2>
            <div align="center">
      ...
      <section class="other">
        <div class="container">
            ...
            <?php
                foreach ($query_pariwisata->result() as $row ) {
                  $gambar = $row->gambar;
                  $url_item = $row->url_item;
                  $edit_item_url = base_url()."adminccm/pariwisata/".$row->id;
          ...
          <div class="col-lg-12" style="margin-bottom: 50px;">
            <div class="col-lg-4">
              <?php if ($gambar=="") {?>
             <a href="<?=base_url()?>home/pariwisata_konten/<?=$url_item?>"><img src="<?php echo $base_url_id?>assets/upload/empty/notfound.jpg" alt="..." class="img-rounded img-responsive" width="250px"></a>   
              <?php }else{ ?>
             <a href="<?=base_url()?>home/pariwisata_konten/<?=$url_item?>"><img src="<?php echo $base_url_id?>assets/upload/pariwisata/<?=$gambar?>" alt="..." class="img-rounded img-responsive" width="250px"></a>
             <?php }?> 
            </div>
            <div class="col-lg-8">
                <a href="<?=base_url()?>home/pariwisata_konten/<?=$url_item?>"><h2><?= $row->judul?></h2></a>
                <p class="caption">
                    <?php
                    $isi = $row->isi;
                    $isi=character_limiter($isi, 200);
                    ?>
                    <?php echo $isi ?>
                </p>
                <a href="<?=base_url()?>home/pariwisata_konten/<?=$url_item?>" class="btn btn-md btn-default">Read more...</a>
            </div>
          </div>
...
<?php } ?>
          ...
          <div align="center" class="col-lg-12" style="margin-bottom: 30px;">
              <h2>Budaya</h2>
            <div class="col-lg-3">
              <img src="<?php echo $base_url_id?>assets/template_web/images/pariwisata/budaya1.jpg" alt="..." class="img-rounded" height="140" widht="140" style="margin-bottom: 20px;">
            </div>
            <div class="col-lg-3">
              <img src="<?php echo $base_url_id?>assets/template_web/images/pariwisata/budaya2.jpg" alt="..." class="img-rounded" height="140" style="margin-bottom: 20px;">
            </div>
            <div class="col-lg-3">
              <img src="<?php echo $base_url_id?>assets/template_web/images/pariwisata/budaya3.jpg" alt="..." class="img-rounded" height="140" style="margin-bottom: 20px;">
            </div>
            <div class="col-lg-3">
              <img src="<?php echo $base_url_id?>assets/template_web/images/pariwisata/budaya4.jpg" alt="..." class="img-rounded" height="140" style="margin-bottom: 20px;">
            </div>
          </div>
          <!--<div align="center">
            <ul class="pagination">
          ...
          <div class="col-lg-12" style="margin-top: 12px;">
            <div class="row">
              ...
              <p style="margin-left: 14px;">
                ...
                <a href="https://centralcelebesmarathon.com/home/pariwisata" class="select2">Indonesia</a> &middot; 
                <a href="https://en.centralcelebesmarathon.com/home/pariwisata" class="select2">English</a>
              </p>
            </div>
          </div>
        </div>
