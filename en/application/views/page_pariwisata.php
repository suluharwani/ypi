          ...
          <div class="col-lg-12">
            ...
            <div align="center">
              <ol class="breadcrumb" style="background-color: transparent; font-size: 17px;">
                ...
                <li><a href="<?=base_url()?>home/pariwisata" style="color: #fff;">Tourism</a></li></li>
...
<!-- konten -->
    <div class="col-lg-12" style="margin-bottom: 30px;">
        ...
        <div align="center">
            <?php if ($gambar=="") {?>
            <img src="<?php echo $base_url_id?>assets/upload/empty/notfound.jpg" alt="..." class="img-rounded img-responsive" >
              <?php }else{ ?>
            <img src="<?php echo $base_url_id?>assets/upload/pariwisata/<?=$gambar?>" alt="..." class="img-rounded img-responsive" width="500px">
             <?php }?> 
        </div>
        ...
        <p>
            Ditambahkan oleh: <?=$penulis?> <br> 
            Pada tangal: <?=$tanggal?> <br><br>
            <a href="<?=base_url()?>home/pariwisata">   <button class="btn btn-danger">Kembali</button> </a>
        </p>
    </div>
<!-- konten -->
