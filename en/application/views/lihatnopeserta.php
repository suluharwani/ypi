...
<html lang="en">
  <head>
    ...
    <title>Central Celebes: Cari</title>
  ...
  <body>
      ...
      <section class="parallax-header">
        <div class="container">
          <div class="col-lg-12">
            <h2 class="judulheader" align="center">LIHAT NO. PENDAFTARAN:  <span class="judulcari">12xx</span></h2>
            <div class="col-lg-4"></div>
            <div class="col-lg-4">
              <ol class="breadcrumb" style="background-color: transparent; font-size: 17px;">
                <li><a href="#" style="color: #fff;">Home</a></li>
                <li><a href="#" style="color: #fff;">Cari</a></li>
                <li class="active">12xxx</li>
              </ol>
            </div>
            <div class="col-lg-4"></div>
          </div>
              ...
              <table class="table table-striped">
                ...
                <tbody>
                  <tr>
                    ...
                    <td><a href="#" class="btn btn-info">Konfirmasi Pembayaran</a></td>
                  </tr>
                  <tr>
                    <td>2</td>
                    <td>2xxxx</td>
                    ...
                    <td><a href="#" class="btn btn-info disabled">Konfirmasi Pembayaran</a></td>
                  </tr>
                  <tr>
                    <td>3</td>
                    <td>3xxxx</td>
                    <td>Peserta 3</td>
                    <td>HM 21K Internasional</td>
                    <td><span class="label label-success">SUDAH</span></td>
                    <td><a href="#" class="btn btn-info disabled">Konfirmasi Pembayaran</a></td>
                  </tr>
                  <tr>
