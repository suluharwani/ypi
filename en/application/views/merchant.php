            ...
            <div align="center">
              ...
              ?>
                <div class="col-lg-3">
                  <div class="thumbnail">
                     <?php if ($gambar=="") {?>
                    <img  src="<?php echo $base_url_id?>assets/upload/empty/notfound.jpg" alt="...">
                    <?php }else{ ?>
                    <img  src="<?php echo $base_url_id?>assets/upload/merchant/<?=$gambar?>" alt="...">
                    <?php }?> 
                    <div class="caption">
                      <h3><?=$row->judul?></h3>
                      <p><?=$row->isi?></p>
                      <p><a href="<?=base_url()?>home/merchant_konten/<?=$url_item?>" class="btn btn-info" role="button">Visit</a> <a href="tel:<?=$row->telepon?>" class="btn btn-success" role="button">Call <?=$row->telepon?></a></p>
                    </div>
                  </div>
                </div>
          ...
          <div class="col-lg-12" style="margin-top: 12px;">
            <div class="row">
              ...
              <p style="margin-left: 14px;">
                ...
                <a href="https://centralcelebesmarathon.com/home/merchant" class="select2">Indonesia</a> &middot; 
                <a href="https://en.centralcelebesmarathon.com/home/merchant" class="select2">English</a>
              </p>
            </div>
          </div>
        </div>
