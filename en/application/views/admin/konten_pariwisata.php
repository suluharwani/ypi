          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Buat <?=$nama_halaman?> <small></small> </h3>
              </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                   ...
                   <!--  <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"> -->
                     ...
                     if ($gambar=="") {
                     ?>
                     <a href="<?php echo$base_url_id?>adminccm/upload_image/<?= $update_id?>"><button type="button" class="btn btn-primary">Upload Gambar Pariwisata</button></a>
                     <?php
                     }else{
                       ?>
                     <a href="<?php echo$base_url_id?>adminccm/hapus_gambar_pariwisata/<?= $update_id?>"><button type="button" class="btn btn-danger">Hapus Gambar Pariwisata</button></a>
                     <?php }?>   
                     <img src="<?=base_url()?>/assets/upload/pariwisata/<?=$gambar?>" width="100px" alt="">
                     <span class="pull-right">
                      <a href="<?php echo$base_url_id?>adminccm/hapus_pariwisata/<?=$update_id?>"><button type="button" onclick="return confirm(`Yakin?`)" class="btn btn-danger">Hapus Halaman</button></a>
                     </span>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                   <!--  <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"> -->
                     <?php  echo form_open_multipart('adminccm/pariwisata');?>
...
<!--                       <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class=" col-xs-12">
                          <textarea class="ckeditor form-control col-md-12 col-xs-12" name="isi" required="required"><?php if (is_numeric($update_id)) {
                            echo $isi;
                          }?></textarea> 
                        </div>
                      </div>
        ...
        <script src="<?=base_url()?>/assets/admin/cleditor.js"></script>
