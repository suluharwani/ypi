                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left input_mask" method="POST">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="number" class="form-control" value="<?=$kuota5k?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                          <button type="submit" value="submit5k" class="btn btn-success">Submit</button>
                        </div>
                      </div>
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left input_mask" method="POST">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Kuota Awal</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="number" class="form-control" value="<?=$kuota10k?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                          <button type="submit" value="submit10k" class="btn btn-success">Submit</button>
                        </div>
                      </div>
      ...
      <!-- 21k -->
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left input_mask" method="POST">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                        <input type="number" class="form-control has-feedback-left" id="inputSuccess2" name="jersey5ks"  value="<?=$jersey21k_s?>">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Kuota Awal</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="number" class="form-control" value="<?=$kuota21k?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                          <button type="submit" value="submit21k" class="btn btn-success">Submit</button>
                        </div>
                      </div>
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left input_mask" method="POST">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Kuota Awal</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="number" class="form-control" value="<?=$kuota42k?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                          <button type="submit" value="submit42k" class="btn btn-success">Submit</button>
                        </div>
                      </div>
