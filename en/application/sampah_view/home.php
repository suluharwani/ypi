...
<html lang="en">
  ...
  <body>
    ...
    <section class="getitem">
      <div class="container">
        ...
        <div class="col-lg-12" align="center" style="margin-bottom: 70px;">
              <h2 style="color: #455A64; font-family: arial black;">SISA KUOTA JERSEY</h2>
              <hr style="border-color: #F44336; border-width: 3px; margin-bottom: 70px;" width="17%">
    ...
    <section id="daftar" class="isi">
        <div class="container">
          <div class="col-lg-12">
            <h2 align="center" style="color: #455A64; font-family: arial black;">PENDAFTARAN</h2>
            <hr style="border-color: #F44336; border-width: 3px; margin-bottom: 70px;" width="17%">

            <div align="center" class="alert alert-danger" role="alert">Mohon untuk mengisi data sesuai data <strong>KTP</strong> anda.</div>
            <form  method="POST">
            <div class="col-lg-6">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control" name="ktp" placeholder="Contoh: 8283012308970434" aria-describedby="sizing-addon2" required="">
              </div>
              <br>
              <label>Nama Lengkap:</label>
              <div class="input-group">
                <span class="input-group-addon" id="sizing-addon2"><span class="glyphicon glyphicon-user" aria-hidden="true"></span></span>
                <input type="text" class="form-control" name="nama" placeholder="Contoh: Agus Suga" aria-describedby="sizing-addon2" required="">
              </div>
              <br>
              <label>Email:</label>
              <div class="input-group">
                <span class="input-group-addon" id="sizing-addon2"><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span></span>
                <input type="email" class="form-control" name="email" placeholder="Contoh: agus.suka@gmail.com" aria-describedby="sizing-addon2" required>
              </div>
              <br>
        ...
        echo form_dropdown('darah', $options_darah,'','class="form-control"');
              ...
              <div class="input-group">
               ...
               <input type="text" class="form-control" name="tempat_lahir" placeholder="Contoh: Palu" aria-describedby="sizing-addon2" required="">
              ...
              <div class="input-group">
                ...
                <textarea type="text" class="form-control" name="alamat" placeholder="Contoh: Jl. Raya Ramai No. 23 Palu" aria-describedby="sizing-addon2" required=""></textarea>
              </div>
              <br>
            ...
            <div class="col-lg-6">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control" name="kota" placeholder="Contoh: Palu" aria-describedby="sizing-addon2" required="">
              </div>
              <br>
              <label>Provinsi:</label>
              <div class="input-group">
                <span class="input-group-addon" id="sizing-addon2"><span class="glyphicon glyphicon-star" aria-hidden="true"></span></span>
                <input type="text" class="form-control" name="provinsi" placeholder="Contoh: Sulawesi Tengah" aria-describedby="sizing-addon2" required="">
              </div>
              <br>
        ...
        echo form_dropdown('kategori_lomba', $options_lomba,'','class="form-control"','required=""');
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control" name="hp" placeholder="Contoh: 081122333444" aria-describedby="sizing-addon2" required="">
              </div>
              <br>
              <label>No. Handphone Darurat (bila terjadi sesuatu):</label>
              <div class="input-group">
                <span class="input-group-addon" id="sizing-addon2"><span class="glyphicon glyphicon-phone" aria-hidden="true"></span></span>
                <input type="text" class="form-control" name="darurat" placeholder="Contoh: 084443332211" aria-describedby="sizing-addon2" required="">
              </div>
              <br>
              <label>Riwayat Penyakit (bila ada):</label>
               <div class="input-group">
               <span class="input-group-addon" id="sizing-addon2"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span></span>
               <input type="text" class="form-control" name="riwayat_penyakit" placeholder="Contoh: Jantung" aria-describedby="sizing-addon2">
              </div>
              <br>
              <label>Komunitas (bila ada):</label>
              <div class="input-group">
                <span class="input-group-addon" id="sizing-addon2"><span class="glyphicon glyphicon-tags" aria-hidden="true"></span></span>
                <input type="text" class="form-control" name="komunitas" placeholder="Contoh: Komunitas Pelari Palu" aria-describedby="sizing-addon2">
              </div>
              <br>
                  ...
                  <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                    <div class="panel-body">
                      ...
                      <table class="table-responsive" style="text-align: justify;">
                        <tr>
                          <td>1.</td>
                          <td>Tidak ada batas usia untuk peserta Central Celebes Marathon 2018.</td>
                        </tr>
                        <tr>
                          <td>2.</td>
                          <td>Peserta hanya akan dibedakan melalui kategori nasional atau internasional.</td>
                        </tr>
                        <tr>
                          <td>3.</td>
                          <td>Pendaftaran hanya dibuka via online. Maka, tidak akan ada peserta yang meminta untuk
                              dibukanya pendaftaran secara offline.</td>
                        </tr>
                        <tr>
                          <td>4.</td>
                          <td>Penyelenggara berhak menutup pendaftaran jika seluruh kuota peserta telah terisi penuh.</td>
                        </tr>
                        <tr>
                          <td>5.</td>
                          <td>Pendaftaran akan diproses setelah pembayaran diselesaikan.</td>
                        </tr>
                        <tr>
                          <td>6.</td>
                          <td>Hadiah akan dikenakan pajak dan potongan sesuai dengan ketentuan yang berlaku.</td>
                        </tr>
                        <tr>
                          <td>7.</td>
                          <td>Penyelenggara berhak menghubungi dan mewawancarai Peserta melalui telepon seluler atau
                              cara lain untuk mendapatkan data yang diperlukan sehubungan dengan pendaftaran mereka.</td>
                        </tr>
                        <tr>
                          <td>8.</td>
                          <td>Biaya pendaftaran adalah tidak dapat diminta kembali (non-refundable). Penyelenggara berhak
                              untuk menolak pendaftaran jika pendaftar memberikan informasi yang salah, tidak melakukan
                              pembayaran atau gagal memenuhi persyaratan yang ditentukan dalam form pendaftaran.</td>
                        </tr>
                        <tr>
                          <td>9.</td>
                          <td>Jika lomba dibatalkan karena alasan di luar kekuasaan Penyelenggara (termasuk hujan deras,
                              petir atau bencana, demonstrasi), Penyelenggara tidak akan mengembalikan biaya pendaftaran
                              yang telah diterima dan Penyelenggara tidak bertanggung jawab atau kewajiban apapun atas hal
                              tersebut.</td>
                        </tr>
                        <tr>
                          <td>10.</td>
                          <td>Olahraga lari bukanlah merupakan olahraga yang tidak memiliki risiko dan karenanya masing-
                              masing pelari wajib memastikan bahwa kondisi kesehatannya fit sebelum dan pada saat
                              berpartisipasi dalam lomba. Masing-masing pelari bertanggung jawab atas kondisi kesehatannya
                              masing-masing. Penyelenggara tidak bertanggung jawab atas cidera ataupun kematian yang
                              timbul selama atau sesudah lomba yang diakibatkan secara langsung merupakan akibat dari
                              kelalaian yang disengaja atau gross negligence Penyelenggara.</td>
                        </tr>
                        <tr>
                          <td>11.</td>
                          <td>Penyelenggara berhak untuk tidak mengizinkan atau mendiskualifikasi peserta yang diketahui
                              atau diduga tidak fit untuk mengikuti perlombaan. Jika terdapat peserta yang cidera pada saat
                              perlombaan berlangsung, dalam keadaan tertentu sesuai dengan rekomendasi petugas
                              kesehatan yang ditunjuk Penyelenggara untuk mengawasi perlombaan, peserta tersebut dapat
                              dirawat di rumah sakit yang ditunjuk Penyelenggara dengan biaya perawatan tidak melebihi
                              jumlah yang disepakati oleh Penyelenggara dan rumah sakit tersebut.</td>
                        </tr>
                        <tr>
                          <td>12.</td>
                          <td>Penyelenggara berhak untuk mendiskualifikasi peserta dan/atau membatalkan hasil lomba
                              sebagai akibat dari adanya pelanggaran atau tidak dipenuhinya ketentuan International
                              Association of Athletics Federations (IAAF) atau PASI atau ketentuan lomba. Penyelenggara tidak
                              wajib mengembalikan biaya pendaftaran dalam hal tersebut.</td>
                        </tr>
                        <tr>
                          <td colspan="2"><br>Saya telah membaca dengan saksama dan memahami perjanjian ini. Saya sadar bahwa ini
                              adalah pelepasan dari tanggung jawab, dan saya berjanji untuk tidak menuntut, dan adalah
                              kontrak antara saya dengan acara Central Celebes Marathon 2018, dan dapat mengikat, ahli
                              waris, wakil pribadi, dan semua anggota keluarga saya, termasuk anak di bawah umur, dan
                              saya menandatangani perjanjian ini atas kemauan saya sendiri.
                              Saya TELAH MEMBACA dan MENERIMA persyaratan &amp; ketentuan.</td>
                        </tr>
                      </table>
                    </div>
                  </div>
